            ...
            ui.row(
                ui.column(
                    ...
                    ui.div(
                        ...
                        ui.p(
                            "The table on the right side gives an overview of the most recent validation runs. Pick a table name (and version) and SpectreApp visualizes key insights."
                        ),
                        ui.p("This app includes:"),
                        ui.tags.ul(
                            ui.tags.li(
                                ui.strong("Overview:"),
                                " Get a quick summary of your dataset’s structure.",
                            ),
                            ui.tags.li(
                                ui.strong("Pipe:"),
                                " Visualizes each step in the validation pipeline.",
                            ),
                            ui.tags.li(
                                ui.strong("Validation:"),
                                " Inspect the full validation report generated by Octopussy/Pointblank.",
                            ),
                            ui.tags.li(
                                ui.strong("Variables:"),
                                " Lists all variables (columns) present across versions.",
                            ),
                            ui.tags.li(
                                ui.strong("Classes:"),
                                " Highlights the value distribution of categorical variables.",
                            ),
                            ui.tags.li(
                                ui.strong("Labels:"),
                                " Shows categories included in the dataset.",
                            ),
                            ui.tags.li(
                                ui.strong("Diff:"),
                                " View the latest changes of the pipeline using Git diff.",
                            ),
                        ),
                    ),
                ),
                ui.column(
                    ...
                    ui.p(
                        "Monitoring data made simple with Spectre.",
...
def about_server(input, output, session):
    ...
    def dependent_select():
        ...
        return ui.input_select(
            "second_choice", "Pick a version (optional):", choices=versions
        )
